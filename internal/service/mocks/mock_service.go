...
func (m *MockPetAdapter) Create(ctx context.Context, req service.CreatePetRequest) (*api.Pet, error) {
	m.ctrl.T.Helper()
...
func (m *MockPetAdapter) Delete(ctx context.Context, req service.DeletePetRequest) error {
	m.ctrl.T.Helper()
...
func (m *MockPetAdapter) Get(ctx context.Context, req service.GetPetRequest) (*api.Pet, error) {
	m.ctrl.T.Helper()
...
func (m *MockPetAdapter) List(ctx context.Context, req service.GetPetsRequest) ([]*api.Pet, error) {
	m.ctrl.T.Helper()
...
func (m *MockPetAdapter) Update(ctx context.Context, req service.UpdatePetRequest) (*api.Pet, error) {
	m.ctrl.T.Helper()
